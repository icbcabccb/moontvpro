...
function HomeClient() {
  ...
  // 🚀 TanStack Query - 使用 useQuery 获取收藏数据
  ...
  // 🚀 TanStack Query - 使用 useQuery 获取播放记录
  ...
  return (
    <PageLayout>
      ...
      <div className='overflow-visible pt-2 md:pt-4 pb-32 md:pb-safe-bottom'>
        {/* 顶部 Tab 切换 */}
