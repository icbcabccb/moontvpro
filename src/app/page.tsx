          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-center md:text-right">
              <div className="flex flex-wrap justify-center md:justify-end gap-x-5 gap-y-2">
                ...
                <a href="https://400821.xyz" target="_blank" rel="noopener noreferrer" className="text-[#60a5fa] hover:text-[#93c5fd] text-sm transition-colors">红月主站</a>
                ...
                <a href="https://rtv.400821.xyz" target="_blank" rel="noopener noreferrer" className="text-[#60a5fa] hover:text-[#93c5fd] text-sm transition-colors">RedMoon-RTV</a>
              </div>
            </div>
          </div>
        </div>
